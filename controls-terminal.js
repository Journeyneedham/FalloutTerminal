        ...
        if (event.key === "Enter") {
            ...
            await (async function() {
                ...
                if (rolled_amount > 13) {
                    ...
                    document.getElementById('full-log-1').dataset.text = "Identified Hostile Targets: 73";

                } else {

                    document.getElementById('full-log-1').dataset.text = "Amenities Defense System: ACTIVATED : Engaging Hostile Combatants...";
