    ...
    // If the user presses the "Enter" key on the keyboard
        if (event.key === "Enter") {
            ...
            await (async function() {
                ...
                console.log();
                rolled_amount = document.getElementsByClassName('rollinput')[0].value;
                
                if (rolled_amount > 15) {

                    document.getElementById('full-log-1').dataset.text = "Stern Generators Activated: DISTRIBUTED TO SHIP STERN";

                } else {

                    document.getElementById('full-log-1').dataset.text = "Stern Generators Activated: DISTRIBUTION INHIBITED BY SYSTEM AI";
